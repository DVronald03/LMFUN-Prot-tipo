function LoginPage({ onSuccess }){
  ...
  return React.createElement(
    'div',
    { className:'min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0a0f1c] to-[#0e1627] p-4 sm:p-6 lg:p-8' },
    React.createElement(
      'div',
      { className:'bg-white rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl overflow-hidden grid grid-cols-1 lg:grid-cols-2' },
      React.createElement(
        'div',
        { className:'order-2 lg:order-1 p-5 sm:p-6 md:p-8 lg:p-10' },
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            null,
            React.createElement('label',{key:'lbl-login',className:'text-sm text-gray-600'},'Login'),
            React.createElement('input',{key:'inp-login',type:'text',autoComplete:'off',value:user,onChange:e=>setUser(e.target.value),className:'w-full border border-gray-300 rounded-lg px-3 py-2 md:px-4 md:py-3'})
          ),
          React.createElement(
            'div',
            null,
            React.createElement('label',{key:'lbl-senha',className:'text-sm text-gray-600'},'Senha'),
            React.createElement('input',{key:'inp-senha',type:'password',autoComplete:'off',value:pass,onChange:e=>setPass(e.target.value),className:'w-full border border-gray-300 rounded-lg px-3 py-2 md:px-4 md:py-3'})
          ),
      ...
      React.createElement(
        'div',
        { className:'order-1 lg:order-2 relative bg-[#0a0f1c] text-white p-6 sm:p-8 lg:p-10 flex flex-col items-center justify-center gap-3 mb-4 lg:mb-0' },
        React.createElement(
          'div',
          { className:'text-lg sm:text-xl md:text-2xl font-bold tracking-wide' },
          React.createElement('span',{key:'bem',className:'text-red-600'},'BEM'),
          React.createElement('span',{key:'vindo'},' VINDO!')
        ),
        React.createElement(
          'div',
          { className:'w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full overflow-hidden ring-2 ring-white/10 bg-transparent shadow-sm' },
